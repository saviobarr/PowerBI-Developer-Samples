...
public class PowerBIService {
	...
	public static EmbedConfig getEmbedConfig(String accessToken, String workspaceId, List<String> reportIds) throws JsonMappingException, JsonProcessingException {
		...
		// Get embed token
		reportEmbedConfig.embedToken = PowerBIService.getEmbedToken(accessToken, reportIds, datasetIds,null,null);
		return reportEmbedConfig;
	}
	...
	public static EmbedConfig getEmbedConfig(String accessToken, String workspaceId, List<String> reportIds, 
			List<String> additionalDatasetIds, List<String> targetWorkspaceIds, List<Identity> identities) throws JsonMappingException, JsonProcessingException {
		...
		// Get embed token
		reportEmbedConfig.embedToken = PowerBIService.getEmbedToken(accessToken, reportIds, additionalDatasetIds, targetWorkspaceIds, identities);
		return reportEmbedConfig;
	}
	...
	public static EmbedToken getEmbedToken(String accessToken, String reportId, List<String> datasetIds, String... targetWorkspaceIds) throws JsonMappingException, JsonProcessingException {
		...
		String srequestBody =  requestBody.toString();
//		String srequestBody =  "{\r\n"
//				+ "    \"datasets\": [\r\n"
//				+ "        {\r\n"
//				+ "            \"id\": \"2172fae9-902b-429c-a8db-060a955327b9\"\r\n"
//				+ "        }\r\n"
//				+ "    ],\r\n"
//				+ "    \"reports\": [\r\n"
//				+ "        {\r\n"
//				+ "            \"id\": \"fe5be853-b822-4da2-8ebf-ffa0ff1ceff7\"\r\n"
//				+ "        }\r\n"
//				+ "    ],\r\n"
//				+ "    \"targetWorkspaces\": [\r\n"
//				+ "        {\r\n"
//				+ "            \"id\": \"3c64fa62-d80a-4c5a-9a66-db442442a36d\"\r\n"
//				+ "        }\r\n"
//				+ "    ],\r\n"
//				+ "    \"identities\": [\r\n"
//				+ "        {\r\n"
//				+ "            \"username\": \"10016396855\",\r\n"
//				+ "            \"roles\": [\r\n"
//				+ "                \"Dynamic_RLS_Orgao\"\r\n"
//				+ "            ],\r\n"
//				+ "            \"datasets\": [\r\n"
//				+ "                \"2172fae9-902b-429c-a8db-060a955327b9\"\r\n"
//				+ "            ],\r\n"
//				+ "            \"customData\": \"|ID_Orgao:8,9,38,@|UA:|\"\r\n"
//				+ "        }\r\n"
//				+ "    ]\r\n"
//				+ "}";
		
		HttpEntity<String> httpEntity = new HttpEntity<> (srequestBody, headers);
	 ...
	 * @throws JsonMappingException 
	 */
	public static EmbedToken getEmbedToken(String accessToken, List<String> reportIds, List<String> datasetIds, List<String> targetWorkspaceIds, List<Identity> identities) throws JsonMappingException, JsonProcessingException {
		...
		for (Identity identity  : identities) {
			...
			jsonIdentity.put("username", identity.getUsername());
			jsonIdentity.put("customData", identity.getCustomData());
			jsonIdentity.put("datasets",jsonDatasets);
			// Add roles id in body
			
			
			JSONArray jsonRoles = new JSONArray();
			for (String role  : identity.getRoles()) {
				JSONObject jsonRole = new JSONObject();
				jsonRole.put("role", role);
				jsonRoles.put(role);
			}
			
			JSONArray jsonDatasetsIn = new JSONArray();
			for (String dataset  : identity.getDatasets()) {
				JSONObject jsonDataset = new JSONObject();
				jsonDataset.put("datasets", dataset);
				jsonDatasetsIn.put(dataset);
			}
			
			jsonIdentity.put("roles",jsonRoles);
			jsonIdentity.put("datasets", jsonDatasetsIn);
			jsonIdentities.put(jsonIdentity);
		...
		requestBody.put("datasets", jsonDatasets);
		requestBody.put("reports", jsonReports);
		requestBody.put("identities", jsonIdentities);
